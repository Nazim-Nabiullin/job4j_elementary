...
class SwitchArrayTest {
    ...
    @Test
    void whenSwapBorderArrayLenghtis4() {
        int[] input = {1, 2, 3, 4};
    ...
    @Test
    void whenSwapBorderArrayLenghtis6() {
    ...
    @Test
    void whenSwapBorderArrayLenghtis3() {
        int[] input = {1, 2, 3};
        int[] result = SwitchArray.swapBorder(input);
        int[] expected = {3, 2, 1};
        assertThat(result).containsExactly(expected);
    ...
    @Test
    void whenSwapBorderArrayLenghtis1() {
        int[] input = {1};
        int[] result = SwitchArray.swapBorder(input);
        int[] expected = {1};
        assertThat(result).containsExactly(expected);
    ...
    void whenSwap1to5() {
        ...
        int[] result = SwitchArray.swap(input, source, destination);
        int[] expected = {1, 6, 3, 4, 5, 2, 7, 8, 9, 10};
        assertThat(result).containsExactly(expected);
    }
}